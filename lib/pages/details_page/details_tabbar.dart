...
class DetailsTabBar extends StatelessWidget {
        ...
        return Container(
          ...
          child: Row(
            children: <Widget>[
              ...
              _muBtabBarLeft(context, isLeft),
              _muBtabBarRihgt(context, isRight),
            ],
          ),
  ...
  Widget _muBtabBarLeft(BuildContext context,bool isLeft) {
    return InkWell(
      onTap: (){
      ...
      child: Container(
        ...
        decoration:BoxDecoration(
          color: Colors.white,
          border: Border(
            bottom: BorderSide(width: 1,color: isLeft?Colors.pink:Colors.white24),
          )
        ),
  ...
  Widget _muBtabBarRihgt(BuildContext context,bool isRight) {
    return InkWell(
      onTap: (){
      ...
      child: Container(
        ...
        decoration:BoxDecoration(
          color: Colors.white,
          border: Border(
            bottom: BorderSide(width: 1,color: isRight?Colors.pink:Colors.white24),
          )
        ),
